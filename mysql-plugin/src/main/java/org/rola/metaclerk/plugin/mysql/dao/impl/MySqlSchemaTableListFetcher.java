...
class MySqlSchemaTableListFetcher extends BaseFetcher {
	private final String objectType;
	
	public MySqlSchemaTableListFetcher(JdbcConnector con, String objectType) {
		setConnector(con);
	...
	private TableList getSafeTableList(String schema) throws SQLException {
		...
		dbc.executeSelectStatement(query, schema.toLowerCase(), objectType.toUpperCase());
